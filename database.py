...
class db_dig(QWidget):
    ...
    def initUI(self):
        ...
        self.label5 = QLabel("提交更改信息 ")
        self.label5.setStyleSheet(stylesheet.Font_zh)
        ...
        self.InFo = QLabel("当前数据库 :")
        self.InFo.setStyleSheet(stylesheet.Font_zh)
        qfl.addRow("",QWidget())
        qfl.addRow(self.InFo,self.splitbox)
        qfl.addRow("",QWidget())

        self.label6 = QLabel("省份         :")
        self.label7 = QLabel("单位         :")
        self.label6.setStyleSheet(stylesheet.Font_zh)
        self.label7.setStyleSheet(stylesheet.Font_zh)
